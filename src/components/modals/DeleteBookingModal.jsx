    ...
    return (
        ...
        >
            <MS.ModalContent>
                ...
                <MS.ModalText>Are you sure you want to delete the booking?</MS.ModalText>
                <MS.ModalButtonGroup>
                    <MS.CloseModal onClick={closeModal}>Cancel</MS.CloseModal>
                    <MS.ConfirmModal onClick={() => deleteBooking(deleteId, setBookings, bookings, closeModal)}>Delete</MS.ConfirmModal>
                </MS.ModalButtonGroup>
            </MS.ModalContent>
        </MS.StyledModal>
    );
